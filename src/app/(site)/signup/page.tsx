                ...
                <FormField control={form.control} name="fullName" render={({ field }) => (
                  <FormItem>
                    ...
                    <div className="relative">
                      ...
                      <FormControl><Input placeholder="John Doe" className="pl-9" {...field} /></FormControl>
                    </div>
                    <FormMessage />
                  </FormItem>
                )} />
                ...
                <FormField control={form.control} name="password" render={({ field }) => (
                  <FormItem>
                    ...
                    <div className="relative">
                      ...
                      <FormControl><Input type={showPassword ? "text" : "password"} placeholder="Min. 6 characters" className="pl-9 pr-9" {...field} /></FormControl>
